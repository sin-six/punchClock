...
void setup_scr_MainMenuScreen(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->MainMenuScreen_label_1, &lv_customer_font_SourceHanSerifSC_Regular_25, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->MainMenuScreen_btn_8, 129, 45);
    ...
    lv_obj_align(ui->MainMenuScreen_btn_8_label, LV_ALIGN_LEFT_MID, 0, 0);
    ...
    lv_obj_set_style_text_font(ui->MainMenuScreen_btn_8, &lv_customer_font_youyuan_14, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->MainMenuScreen_btn_8, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->MainMenuScreen_btn_8, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->MainMenuScreen_minuteUpButton, 200, 63);
