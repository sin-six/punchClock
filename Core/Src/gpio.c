...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, BLK_Pin|LCD_DC_Pin|LCD_RESET_Pin|LCD_CS_Pin
                          |CD_CS2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(RC522_RST_GPIO_Port, RC522_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RC522_CS_Pin|I2C1_SCL_Pin|I2C1_SDA_Pin|CTP_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : BLK_Pin LCD_RESET_Pin LCD_CS_Pin CD_CS2_Pin */
  GPIO_InitStruct.Pin = BLK_Pin|LCD_RESET_Pin|LCD_CS_Pin|CD_CS2_Pin;
  ...
  /*Configure GPIO pins : SD_CD_Pin LD2410_OUT_Pin */
  GPIO_InitStruct.Pin = SD_CD_Pin|LD2410_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
