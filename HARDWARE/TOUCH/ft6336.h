...
#define CTP_RST_PORT CTP_RST_GPIO_Port
#define CTP_RST_PIN CTP_RST_Pin
#define CTP_INT_PORT CTP_INT_GPIO_Port
#define CTP_INT_PIN CTP_INT_Pin

// 与电容触摸屏连接的芯片引脚(未包含IIC引脚)
// IO操作函数
#define FT_RST(n) (n ? HAL_GPIO_WritePin(CTP_RST_PORT, CTP_RST_PIN, GPIO_PIN_SET) : \
                       HAL_GPIO_WritePin(CTP_RST_PORT, CTP_RST_PIN, GPIO_PIN_RESET)) // FT6336复位引脚
#define FT_INT HAL_GPIO_ReadPin(CTP_INT_PORT, CTP_INT_PIN)                           // FT6336中断引脚
